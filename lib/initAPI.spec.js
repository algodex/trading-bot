...
test("can initialize api", () => {
  process.env.NEXT_PUBLIC_ALGOD_SERVER = "https://node.testnet.algoexplorerapi.io";
  process.env.NEXT_PUBLIC_ALGOD_PORT = 8080;
  process.env.NEXT_PUBLIC_ALGOD_TOKEN = "asdasdasda";

  process.env.NEXT_PUBLIC_INDEXER_SERVER = "https://algoindexer.testnet.algoexplorerapi.io";
